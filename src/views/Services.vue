    ...
    <b-card-group columns class="mt-2">
      <b-card title="Tours and Charters" img-top>
        ...
        <b-card-text class="mt-2">
          ...
          separate Minibuses. You have found the right company. Please click
          here to submit the details of your request for a quote.
        </b-card-text>
      </b-card>
      ...
      <b-card title="Toronto Sight Seeing" img-top>
        <img
          class="card-img img-fluid"
      ...
      <b-card title="Airport Transfer" img-top>
        <img
          class="card-img img-fluid"
      ...
      <b-card title="Niagara Falls Sightseeing" img-top>
        <img
          class="card-img img-fluid"
        ...
        <b-card-text class="mt-2">
          ...
          <ul>
            ...
            <li>Maid Of The Mist Boat Cruise</li>
      ...
      <b-card title="Limousine service" img-top>
        <img
          class="card-img img-fluid"
        ...
        <b-card-text class="mt-2">
          Submit a quote on conatct us page
        </b-card-text>
      </b-card>

      <b-card title="Winery Tours" img-top>
        <img
          class="card-img img-fluid"
